...
// If you use the same ID for the menu item as for the destination fragment,
// you don't need to write any code at all to implement the onClick listener!
class AboutFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.playButtonInAbout.setOnClickListener {view:View->
